...
**Estimate**: 4 hours (research) + 2 hours (implementation)
...
- ✅ Feed URLs auto-update on 301 redirects (from v0.4.0)
- ✅ Feeds fetched at appropriate intervals (not all at once)
- ✅ Less bandwidth usage (smart scheduling)
